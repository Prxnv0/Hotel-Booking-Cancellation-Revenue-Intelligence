...
├── requirements.txt
│
├── data/                            # Create locally after downloading dataset
│   ├── raw/
│   │   └── hotel_bookings.csv        # Download separately from Kaggle
│   │
│   └── processed/
│       └── hotel_bookings_cleaned.csv # Generated by data_cleaning.py
├── src/
│   ├── data_cleaning.py
...
The dataset is not included in this repository due to file upload limitations.

Download the **Hotel Booking Demand Dataset** from:
...
### 3. Run the Python Analysis Pipeline
